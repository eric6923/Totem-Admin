import { Download, Book, Users, Award, Search, Filter, MoreVertical } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 xl:gap-8 mb-10">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center">
              ...
              <div className="ml-6">
                <h3 className="text-2xl xl:text-3xl font-bold text-gray-800 dark:text-white">1,234</h3>
                <p className="text-base text-gray-500 dark:text-gray-400 mt-1">Total Courses</p>
              </div>
            </div>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center">
              ...
              <div className="ml-6">
                <h3 className="text-2xl xl:text-3xl font-bold text-gray-800 dark:text-white">2,834</h3>
                <p className="text-base text-gray-500 dark:text-gray-400 mt-1">Team Members</p>
              </div>
            </div>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center">
              ...
              <div className="ml-6">
                <h3 className="text-2xl xl:text-3xl font-bold text-gray-800 dark:text-white">987</h3>
                <p className="text-base text-gray-500 dark:text-gray-400 mt-1">Certificates Issued</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <tbody>
        {recentOrders.map((order, index) => (
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-xl font-semibold text-gray-800 dark:text-white">To Do List</h2>
              <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                <Filter size={20} className="text-gray-500" />
              </button>
            </div>
              ...
              {todos.map((todo, index) => (
                <div
                  ...
                  className={`flex items-center justify-between p-4 rounded-xl ${
                    todo.completed ? 'bg-blue-50 dark:bg-blue-900/20' : 'bg-gray-50 dark:bg-gray-700/50'
                  }`}
                >
                  <span className={`text-base ${todo.completed ? 'text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-300'}`}>
                    {todo.text}
                  </span>
