...
export default function Navbar({ sidebarOpen, setSidebarOpen, darkMode, setDarkMode }: NavbarProps) {
  ...
  <div className="relative w-full max-w-md">
    {/* <input
      type="search"
      placeholder="Search..."
      className="w-full pl-4 pr-10 py-2 rounded-lg border border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
    /> */}
